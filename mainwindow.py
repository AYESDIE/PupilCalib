...
class MainWindow(QMainWindow):
    ...
    def on_acquisition_timer(self):
        ...
        try:
            ...
            reshaped_img = converted_ipl_image.get_numpy_3D()
            gray = cv2.cvtColor(reshaped_img, cv2.COLOR_RGB2GRAY)
            ...
            if ret == True:
                ...
                cv2.drawChessboardCorners(reshaped_img, (7, 6), corners2, ret)
                cv2.imshow('img', reshaped_img)
                cv2.waitKey(500)
